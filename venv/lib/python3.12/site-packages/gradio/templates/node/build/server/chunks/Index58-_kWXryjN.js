...
import { B as Block, S as Static, x as MarkdownCode, G as Check, z as Copy, V as Minimize, W as Maximize } from './2-DeykbhT8.js';
import { w as writable } from './index-BJuG1GWC.js';
import { d as dequal } from './index6-sfNUnwRZ.js';
import { U as Upload } from './ModifyUpload-DBjFnhwc.js';
import Index$1 from './Index23-d8lmkmkN.js';
export { default as BaseExample } from './Example8-DGFYm5Tl.js';
import 'tty';
import 'path';
import 'url';
import 'fs';
import './ImagePreview-sp1yRHwu.js';
import './Example11-CsdDoXYD.js';
...
const CellMenuButton = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<button aria-label="Open cell menu" class="cell-menu-button svelte-vt38nd" data-svelte-h="svelte-r2x3m0">⋮
</button>`;
});
const css$7 = {
...
const CellMenu = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  can_add_rows = row_count[1] === "dynamic";
  can_add_columns = col_count[1] === "dynamic";
  return `<div class="cell-menu svelte-42thj4"${add_attribute("this", menu_element, 0)}>${is_header ? `<button class="${["svelte-42thj4", sort_direction === "asc" ? "active" : ""].join(" ").trim()}">${validate_component(CellMenuIcons, "CellMenuIcons").$$render($$result, { icon: "sort-asc" }, {}, {})} ${escape(i18n("dataframe.sort_ascending"))} ${sort_direction === "asc" && sort_priority !== null ? `<span class="priority svelte-42thj4">${escape(sort_priority)}</span>` : ``}</button> <button class="${["svelte-42thj4", sort_direction === "desc" ? "active" : ""].join(" ").trim()}">${validate_component(CellMenuIcons, "CellMenuIcons").$$render($$result, { icon: "sort-desc" }, {}, {})} ${escape(i18n("dataframe.sort_descending"))} ${sort_direction === "desc" && sort_priority !== null ? `<span class="priority svelte-42thj4">${escape(sort_priority)}</span>` : ``}</button> <button class="svelte-42thj4">${validate_component(CellMenuIcons, "CellMenuIcons").$$render($$result, { icon: "clear-sort" }, {}, {})} ${escape(i18n("dataframe.clear_sort"))}</button>` : ``} ${!is_header && can_add_rows ? `<button class="svelte-42thj4">${validate_component(CellMenuIcons, "CellMenuIcons").$$render($$result, { icon: "add-row-above" }, {}, {})} ${escape(i18n("dataframe.add_row_above"))}</button> <button class="svelte-42thj4">${validate_component(CellMenuIcons, "CellMenuIcons").$$render($$result, { icon: "add-row-below" }, {}, {})} ${escape(i18n("dataframe.add_row_below"))}</button> ${can_delete_rows ? `<button class="delete svelte-42thj4">${validate_component(CellMenuIcons, "CellMenuIcons").$$render($$result, { icon: "delete-row" }, {}, {})} ${escape(i18n("dataframe.delete_row"))}</button>` : ``}` : ``} ${can_add_columns ? `<button class="svelte-42thj4">${validate_component(CellMenuIcons, "CellMenuIcons").$$render($$result, { icon: "add-column-left" }, {}, {})} ${escape(i18n("dataframe.add_column_left"))}</button> <button class="svelte-42thj4">${validate_component(CellMenuIcons, "CellMenuIcons").$$render($$result, { icon: "add-column-right" }, {}, {})} ${escape(i18n("dataframe.add_column_right"))}</button> ${can_delete_cols ? `<button class="delete svelte-42thj4">${validate_component(CellMenuIcons, "CellMenuIcons").$$render($$result, { icon: "delete-column" }, {}, {})} ${escape(i18n("dataframe.delete_column"))}</button>` : ``}` : ``} </div>`;
});
const css$1 = {
...
//# sourceMappingURL=Index58-_kWXryjN.js.map
