...
import { B as Block, S as Static, f as BlockLabel, Q as Code$2, h as Empty, j as IconButton, z as Copy$1, D as DownloadLink, k as Download$1, i as IconButtonWrapper } from './2-DeykbhT8.js';
...
const lang_map = {
  python: () => import('./index29-DLgTmkC9.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index30-Cs27E30S.js'),
      import('./frontmatter-DsgXolf7.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index34-hcH766k9.js').then((m) => m.json()),
  html: () => import('./index31-BSJNMhJL.js').then((m) => m.html()),
  css: () => import('./index32-y98Di7iC.js').then((m) => m.css()),
  javascript: () => import('./index33-Bgvf5TWK.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index33-Bgvf5TWK.js').then(
...
//# sourceMappingURL=Index13-2y7SAntQ.js.map
